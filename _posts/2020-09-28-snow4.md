---
layout: post
title: "John Snow: Six pumps"
date: 2020-09-28 12:27:00
image: /assets/img/
description:
...
$('#map').on('mouseout', function(){ map.scrollWheelZoom.disable();});
  ...
  $.getJSON("../data/pumps.geojson",function(data){
    ...
    var json = var geojsonMarkerOptions = {
    radius: 8,
    fillColor: "#ff7800",
    color: "#000",
    weight: 1,
